...
public class GenerateCloudinarySignatureUseCase {
    ...
    public CloudinarySignatureDto execute() {
        ...
        // Thư mục lưu ảnh trên Cloudinary (Khớp với UI của bạn)
        String folder = "mss301/fpt_car_rental_assets/cars";
        
        // Theo chuẩn Cloudinary, chuỗi các tham số (parameters) phải được sắp xếp theo thứ tự alphabet của key.
        // Ở đây ta có 2 param là 'folder' và 'timestamp'. Chữ 'f' đứng trước 't' nên chuỗi sẽ là: folder=...&timestamp=...
